...
| 5 | スイッチフォーム | ポロン、0.5mm厚 | 1枚 |
| 6 | ソケットフォーム | ポリエチレン or ポロン、1.5mm厚 | 1枚 |
| 7 | ケースフォーム | ポロン、1.5mm厚 | 1枚 |
...
1. **スタビライザーの組み立て**  
   ...
   シリンジ(注射器)でグリスをハウジングの内部に注入する (必須ではありません)
1. **スタビライザーの取り付け**  
...
1. **JSTケーブルをUSB-Cドーターボードに接続**  
   ...
   JSTケーブルのコネクタは裏表があるので、コネクタから端子が見えていない面を上側に向けて挿します  
   斜めに挿すとコネクタやピンが破損してしまいますので、まっすぐに挿してください
1. **USB-Cドーターボードの取り付け**  
...
1. **ソケットフォームの貼り付け**  
   ...
   メインPCBの裏面にグリスや手脂が付着しているとソケットフォームが貼り付きにくくなるので、ティッシュなどで汚れを落としてください  
   ソケットフォームの接着面のフィルムをはがし、メインPCBの裏面に貼り付けます  
   ソケットフォームの両端を両手で持ってピンと張り、真上から見て穴の位置を合わせてメインPCBに置きます  
   ずれてやり直すと接着力落ちるので、慎重に作業してください  
1. **ケースフォームの取り付け**  
